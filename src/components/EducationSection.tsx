        ...
        <section className="section-wrap py-24 relative z-10" id="education">
            ...
            <div className="mt-12 grid gap-6 md:grid-cols-2 lg:gap-8 relative z-10">
                {education.map((item, index) => {
                    ...
                    return (
                        <motion.article
                            className={`glass-panel p-8 md:p-10 group relative overflow-hidden flex flex-col ${isHero ? 'md:col-span-2' : 'md:col-span-1'
                                }`}
                        ...
                        >
                            ...
                            <div
                                ...
                                style={item.color ? { background: `radial-gradient(circle at top right, ${item.color}, transparent 70%)` } : {}}
                            />
                                    ...
                                    {item.achievements.map((achievement, i) => (
                                        ...
                                        >
                                            <span
                                                ...
                                                style={item.color ? { backgroundColor: item.color, boxShadow: `0 0 8px ${item.color}` } : { backgroundColor: '#e384b2' }}
                                            />
