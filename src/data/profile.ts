...
export const skillCategories: SkillCategory[] = [
  {
    title: 'Languages',
    items: [
      { name: 'Java', note: 'Enterprise JVM applications', icon: FaJava, color: '#ED8B00' },
      { name: 'Python', note: 'Data pipelines & ML scripting', icon: SiPython, color: '#3776AB' },
      { name: 'TypeScript', note: 'Typed full-stack environments', icon: SiTypescript, color: '#3178C6' },
      { name: 'JavaScript', note: 'Dynamic web scripting', icon: SiJavascript, color: '#F7DF1E' },
      { name: 'SQL', note: 'Database query language', icon: FaDatabase, color: '#4479A1' },
      { name: 'HTML', note: 'Web page building blocks', icon: SiHtml5, color: '#E34F26' },
    ],
  },
  {
    title: 'Backend & Web Frameworks',
    items: [
      { name: 'Spring Boot', note: 'Robust APIs & microservices', icon: SiSpringboot, color: '#6DB33F' },
      { name: 'Django', note: 'Python web scaffolding', icon: SiDjango },
      { name: 'Flask', note: 'Micro web framework', icon: SiFlask },
      { name: 'Node.js', note: 'Server-side runtimes', icon: SiNodedotjs, color: '#339939' },
  ...
  },
  {
    title: 'ML & AI',
    items: [
      { name: 'Gemini', note: 'Cloud LLM APIs', icon: SiGooglegemini, color: '#8E75B2' },
      { name: 'Ollama', note: 'Local LLM APIs', icon: SiOllama },
      { name: 'LangChain', note: 'Agentic orchestration', icon: SiLangchain },
      { name: 'Transformers', note: 'Hugging Face models', icon: SiHuggingface, color: '#FFD21E' },
      { name: 'PyTorch', note: 'Deep learning framework', icon: SiPytorch, color: '#EE4C2C' },
    ],
  },
  {
    ...
    items: [
      ...
      { name: 'OpenTelemetry', note: 'Distributed tracing system', icon: SiOpentelemetry },
      { name: 'Prometheus', note: 'Metrics reporting & Micrometer', icon: SiPrometheus, color: '#E6522C' },
      { name: 'JUnit', note: 'Java testing framework', icon: SiJunit5, color: '#25A162' },
      { name: 'Pytest', note: 'Python testing framework', icon: SiPytest, color: '#0A9EDC' },
      { name: 'Testcontainers', note: 'Integration testing', icon: FaDocker, color: '#2496ED' },
    ],
  },
  {
    title: 'Cloud & Kubernetes',
    items: [
      { name: 'Google Cloud Platform', note: 'Cloud Run, Pub/Sub, Storage', icon: SiGooglecloud, color: '#4285F4' },
      { name: 'AWS', note: 'EC2, RDS, S3, Lambda', icon: SiAmazonwebservices, color: '#FF9900' },
      { name: 'Docker', note: 'Containerization', icon: SiDocker, color: '#2496ED' },
      { name: 'Kubernetes', note: 'Container orchestration', icon: SiKubernetes, color: '#326CE5' },
      { name: 'Terraform', note: 'Infrastructure-as-Code', icon: SiTerraform, color: '#844FBA' },
      { name: 'GitHub Actions', note: 'CI/CD pipelines', icon: SiGithubactions, color: '#2088FF' },
    ],
  },
  {
    title: 'Databases',
    items: [
      { name: 'PostgreSQL', note: 'Relational, pgvector, PostGIS', icon: SiPostgresql, color: '#336791' },
      { name: 'MySQL', note: 'Relational databases', icon: SiMysql, color: '#4479A1' },
      { name: 'Microsoft SQL Server', note: 'Relational databases', icon: DiMsqlServer, color: '#CC292B' },
      { name: 'Firestore', note: 'NoSQL document datastore', icon: SiFirebase, color: '#FFCA28' },
      { name: 'Redis', note: 'In-memory caching', icon: SiRedis, color: '#DC382D' },
      { name: 'Elasticsearch', note: 'High-performance search', icon: SiElasticsearch, color: '#005571' },
    ],
  },
]
